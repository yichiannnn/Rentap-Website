...
// Secondary ordering, excluding head-to-head. Exported so lib/advance.js can
// rank teams across different groups (e.g. "best Runner-up"), where the
// within-a-group head-to-head step above doesn't apply.
export function baseCompare(sport, a, b) {
  if (sport === 'volleyball') {
